...
$(document).ready(function() {
  ...
  function customization() {
    ...
    setInterval(() => {
      ...
      $('.post-footer > small.pull-right span.post-tools')
        .each(function(i) { i > 0 && $(this).hide() });
      // hide redundant post bar
      $('.post-bar').each(function(i) { i > 0 && $(this).hide() });
      // hide redundant rectangle reply button
      $('.topic-main-buttons > div[component="topic/reply/container"]')
        .each(function(i) { i > 0 && $(this).hide() });
      // hide redundant post
      $('ul.posts > li[component="post"]').each(function(i) { i > 0 && $(this).hide() });
