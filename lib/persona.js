...
$(document).ready(function() {
  ...
  function customization() {
    ...
    setInterval(() => {
      ...
      var userId = $('ul#user-control-list > li:first-child > a').attr('href')
        ? $('ul#user-control-list > li:first-child > a').attr('href').replace(/^\/user\//, '')
        : null
      var firstEditorId = $('ul[component="topic"]:first > li[component="post"]:first').attr('data-username')
      if (userId !== firstEditorId && userId !== ADMIN_ID) {
        var inThreadPostQuerys = userId
          ? $('div[component="post/replies"] > li[component="post"]')
            .not(`[data-username="${userId}"]`)
          : $('div[component="post/replies"] > li[component="post"]');
        ...
        inThreadPostQuerys.find('div[component="post/content"]').each(hidePost);
        // other posts
        $('ul.posts > li[component="post"] > div[component="post/content"]').slice(1).each(hidePost);
      }
